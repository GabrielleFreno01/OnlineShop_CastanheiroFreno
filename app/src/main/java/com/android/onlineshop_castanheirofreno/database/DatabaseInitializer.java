...
public class DatabaseInitializer {
    ...
    private static void addItem(final AppDatabase db, final String name, final String description, final int price, final long idCategory){//, final long idImage) {
    ...
    private static void populateWithTestData(AppDatabase db) {
       ...
       /* //Images
        ...
        addItem(db, "Acer Aspire VX", "Wonderful computer", 950, 3);//;, 2);

        addItem(db, "Apple IMac" , "Perfect for work", 1020, 3);//, 1);
